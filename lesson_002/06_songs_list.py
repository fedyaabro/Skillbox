...
enjoy = violator_songs_list[-4][1]
clean = violator_songs_list[-1][1]
total_song_time = round((halo + enjoy + clean), 3)

print('Три песни звучат = ', total_song_time, ' ', 'минут' )
...
total_song_time_2 = round((sweetest + policy + blue), 3)

print('А другие три песни звучат = ', total_song_time_2, ' ', 'минут' )